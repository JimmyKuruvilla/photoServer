...
# while [ true ]
# do
#  webpath=$(curl -s http://$HOST:4000/random?type=image | jq --raw-output .webPath)
...
#  clear	
# done
#curl http://192.168.2.123:4000/Archive/MDACamp.SU2003/MDACamp.2003[Ben]/mdcamp104.jpg | fim -i
